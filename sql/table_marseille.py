...
#creation de la base avec les valeurs comme sur l'exercice
		try:
			...
			c.execute('insert into vente values (null,"bookC","4")')
			c.execute('insert into vente values (null,"bookA","3")')
			c.execute('insert into vente values (null,"bookB","9")')
			c.execute('insert into vente values (null,"bookC","11")')
